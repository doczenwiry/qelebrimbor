...
from qelebrimbor.core.bg.attributes import CubeId, CubeKind, PipeId
from qelebrimbor.core.components import BgCube, BgPipe
from qelebrimbor.core.coordinates import Coordinates
from qelebrimbor.core.volumetric_zx_graph import VolumetricZxGraph
from qelebrimbor.core.zx.attributes import (
    EdgeId,
    EdgeType,
    LayerId,
    NodeId,
...
class VZX:
    ...
    def into_file(graph: VolumetricZxGraph, filepath: str):
        with open(filepath, "w") as file:
            ...
            file.writelines([f"{pipe.source.id};{pipe.target.id};{pipe.type.name}\n" for pipe in graph.get_bg_pipes()])
            ...
            while current_line and current_line != "\n":
                if current_line != "":
                    if ang_format:
                        ...
                        source_id, target_id, pipe_type_str = current_line.split(";")
                        pipe_type = EdgeType[pipe_type_str]
