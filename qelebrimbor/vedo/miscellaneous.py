...
from vedo import Assembly, Cube, Text3D  # type: ignore[import-untyped]
...
class VdCubeReference(Assembly):
    ...
    def __init__(self):
        ...
        for label, direction in [
            ("X", SpacetimeHelper.XP),
            ("X", SpacetimeHelper.XM),
            ("Y", SpacetimeHelper.YP),
            ("Y", SpacetimeHelper.YM),
            ("Z", SpacetimeHelper.ZP),
            ("Z", SpacetimeHelper.ZM),
        ]:
