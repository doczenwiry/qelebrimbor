...
if __name__ == "__main__":
    ...
    ring = ringfinder.find_optimum(zx_cycle, maximal_excess=MAX_OVERHEAD + 4)
    ...
    if ring is None:
        ...
        viewer = VolumetricZxGraphViewer(vzx, label=f"Identity Ring, n={LENGTH}", layout=CycleLayout(vzx))
        viewer.display()
