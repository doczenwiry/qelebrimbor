...
if __name__ == "__main__":
    ...
    for realisation in rings[:1]:
        ...
        BlockGraphConstructor.realise_nodes(vzx = vzx, specifications = realisation.to_nodes_specifications())
        BlockGraphConstructor.realise_edges(vzx = vzx, specifications = realisation.to_edges_specifications(vzx))
